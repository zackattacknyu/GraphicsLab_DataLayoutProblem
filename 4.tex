...
spans for a single data unit ends up being $O(rN)$\YOON{I cannot follow this argument, mainly because I didn't read the cited paper. Probably, reviewers will face the similar problem. So, give more logic on why we reach $rN$ factor here}. 
