...
\title{A Greedy Heuristic using Redundancy for (TODO: Figure out this part of the title: the Data Layout Problem) on Cache Oblivious Mesh Layouts}
...
\\
**TODO: Talk about Yoon's paper. Want to mention the terminology used by this paper. Mention the heuristic they have. **\\
\\
...
**TODO: Mention the fact that if we have data units closer together, then the walkthrough performance will be significantly better. The target of this algorithm is to put them closer together to achieve this**\\
\\
...
**TODO: Put this into an appendix at the end of the paper**
...
\\
**TODO: Mention layout of access requirements as potential future work. Since we have a good algorithm for what happens once we obtain the access requirements, a good extension then is an algorithm for how the access requirements should be laid out in the first place**\\
\\
**TODO: Investigate usage history of an application and group data units together in an access requirement if they end up having a high probability of being accessed together**\\
\\
